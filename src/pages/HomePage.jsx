...
/* ── Marquee logos ─────────────────────────────────────────────────────────── */
const MARQUEE_ITEMS = [
  { label: "Miss & Mister Dour",  href: "https://missetmisterdour.be",  color: BRAND.gold    },
  { label: "Fashionist'ART",      href: "https://fashionistartdour.be", color: "#c084fc"     },
  { label: "Le Tour de Dour",     href: "/tour-de-dour",                color: "#D47A2C",   internal: true },
  { label: "P&V Assurances",      href: "https://assurancesdour.be",    color: "#4a9eff"     },
  { label: "Synergie Dour",       href: "https://synergiedour.be",      color: "#6ee7b7"     },
  { label: "Miss & Mister Dour",  href: "https://missetmisterdour.be",  color: BRAND.gold    },
  { label: "Fashionist'ART",      href: "https://fashionistartdour.be", color: "#c084fc"     },
  { label: "Le Tour de Dour",     href: "/tour-de-dour",                color: "#D47A2C",   internal: true },
  { label: "P&V Assurances",      href: "https://assurancesdour.be",    color: "#4a9eff"     },
